...
export const source: LunaticSource = {
    ...
    "components": [
        ...
        },
        {
            ...
            "page": "1",
            "label": {
                "value": '"➡ 3. " || "Numérique entier sans unité - grand (max= 999999999)"',
                "type": "VTL|MD",
            },
            "declarations": [
                {
        ...
        },
        {
            ...
            "page": "2",
            "label": {
                "value": '"➡ 2. " || "Question à choix unique - présentation case à cocher décochable"',
                "type": "VTL|MD",
            },
            "components": [
                {
        ...
        },
        {
            ...
            "page": "2",
            "label": {
                "value": '"➡ 4. " || "Question à choix unique - présentation liste déroulante"',
                "type": "VTL|MD",
            },
            "components": [
                {
        ...
        },
        {
            ...
            "page": "2",
            "label": {
                "value": '"➡ 7. " || "Question à choix multiple - réponse booléen basique"',
                "type": "VTL|MD",
            },
            "components": [
                {
        ...
        },
        {
            ...
            "page": "2",
            "label": {
                "value": '"➡ 8. " || "Question à choix multiple - réponse oui/non case à cocher"',
                "type": "VTL|MD",
            },
            "components": [
                {
        ...
        },
        {
            ...
            "page": "3",
            "label": {
                "value": '"➡ 3. " || "Tableau un axe simple, plusieurs mesures, sans unité"',
                "type": "VTL|MD",
            },
            "components": [
                {
        ...
        },
        {
            ...
            "page": "3",
            "label": {
                "value": '"➡ 4. " || "Tableau 2 axes - 1 mesure de type numérique, sans unité"',
                "type": "VTL|MD",
            },
            "components": [
                {
        ...
        },
        {
            ...
            "page": "3",
            "label": {
                "value": '"➡ 6. " || "Tableau dynamique jusque 5 lignes, 2 mesures dont une unité "',
                "type": "VTL|MD",
            },
            "declarations": [
                {
