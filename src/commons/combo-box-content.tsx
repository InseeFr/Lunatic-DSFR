...
export function ComboBoxContent({ children, focused, onFocus, onBlur, onKeyDown }: Props) {
    ...
    return (
        <div
            ...
            tabIndex={0}
        >
            <div className={classnames("lunatic-combo-box-content", { focused })}>{children}</div>
        </div>
    );
}
