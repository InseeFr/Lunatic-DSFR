...
describe("Selection component", () => {
    ...
    it("should render correctly with default props", () => {
        const { container } = render(<Selection labelRenderer={LabelRenderer} options={options} />);
    ...
    it("should render correctly when it is editable", () => {
        const { container } = render(
            <Selection labelRenderer={LabelRenderer} options={options} editable={true} />,
        );
    ...
    it("should render correctly when it is expanded", () => {
        const { container } = render(
            <Selection labelRenderer={LabelRenderer} options={options} expanded={true} />,
        );
    ...
    it("should render correctly when it is disabled", () => {
        const { container } = render(
            <Selection
                labelRenderer={({ option }) => <div>{option ? option.label : "No selection"}</div>}
                options={options}
                disabled={true}
            />,
        );
